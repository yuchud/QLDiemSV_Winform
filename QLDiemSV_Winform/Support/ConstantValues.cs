...
namespace QLDiemSV_Winform.Support
{
    internal class ConstantValues
    {
        ...
        public static readonly string TenFormKhoiPhucMatKhau = "Khôi phục mật khẩu";
        public static readonly string TenFormQuanLyGiangVien = "Quản lý giảng viên";
        public static readonly string TenFormQuanLyLopSinhVien = "Quản lý lớp sinh viên";
        public static readonly string TenFormQuanLyMonHoc = "Quản lý môn học";
        ...
        public static readonly string TenFormQuanLyKhoa = "Quản lý khoa";
